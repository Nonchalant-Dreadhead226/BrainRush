    ...
    <div class="home-info">
        <div class="home-info-grid">
            <div class="home-info-card">
                <div class="home-info-icon">⚡</div>
                <div class="home-info-label">Vidējais laiks</div>
                <div class="home-info-value">273 ms</div>
                <div class="home-info-desc">Vidējais cilvēka reakcijas laiks</div>
            </div>
            <div class="home-info-card">
                <div class="home-info-icon">🎯</div>
                <div class="home-info-label">Mērķis</div>
                <div class="home-info-value">&lt; 200 ms</div>
                <div class="home-info-desc">Lielisku rezultātu robeža</div>
            </div>
            <div class="home-info-card">
                <div class="home-info-icon">🖥️</div>
                <div class="home-info-label">Latentums</div>
                <div class="home-info-value">10 – 150 ms</div>
                <div class="home-info-desc">Datora un monitora papildlaiks</div>
            </div>
        </div>
    </div>
</div>
